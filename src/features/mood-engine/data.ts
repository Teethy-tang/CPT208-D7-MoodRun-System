...
export const wisdomQuotes = {
  ...
  anxious: ['A calm pace is still progress.', 'Follow the next step, not the whole storm.'],
  tired: ['Small energy is still energy.', 'Starting gently is a valid kind of strength.'],
  angry: [
    'Power becomes useful when it has direction.',
    'Let the heat leave without burning the room.',
  ],
  sad: ['A soft step can be a brave step.', 'You do not need to feel bright to keep moving.'],
  bored: [
    'Novelty often starts with changing one small path.',
    'Curiosity is momentum in disguise.',
  ],
  excited: ['Energy gets stronger when it learns focus.', 'Keep the spark, choose the line.'],
  happy: ['Joy grows when you give it a route.', 'Good days deserve to be remembered too.'],
  neutral: ['Balance is built in ordinary minutes.', 'A steady step can reset the whole day.'],
};
